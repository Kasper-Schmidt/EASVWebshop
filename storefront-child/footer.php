...
?>
        ...
        <div class="footerboks">
            <div class="venstreside">
                <h3 class="hovedh">KONTAKT</h3>
                
                <p>Spangbjerg Kirkevej 103 <br>6700 Esbjerg</p>
                </a>
                <a href="http://webshopeasv.local/kontakt/">
                    <p class="tlfnummer">marketing@easv.dk</p>
                </a>
                <a href="http://webshopeasv.local/kontakt/">
                    <p class="tlfnummer">Tlf.: +45 6713 3200</p>
                </a>
            </div>
